...
config = [Nx Ny Lx Ly dX dY dt dampX dampY rho0 coh loadValue loadType nIter eIter outputStep devices];
fil = fopen('config.dat', 'wb');
fwrite(fil, config(:), 'double');
fclose(fil);
